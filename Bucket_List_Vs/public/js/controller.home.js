...
function homeController (bucketFactory, $http){
        ...
        bucketFactory.getBucket()
            .then(function(returnData){
                ...
                if(returnData.data !== undefined){
                    ...
                    //     // console.log("Bucket Complete: " + i + " " + home.bucketList[i].bucketcomp)
                    ...
                    //     if (home.bucketList[i].bucketcomp === true) {
                    //         diffDays = "You're Done!"
                    //         home.bucketList[i].bucketdays = diffDays; 
                    //     } else {
                    //         home.bucketList[i].bucketdays = diffDays; 
                    //     }
    ...
    home.dateCalc = function() {
                        ...
                        if (home.bucketList[i].bucketcomp === true) {
                            ...
                            home.bucketList[i].bucketdays = "Due Now";
                        } else {
                            home.bucketList[i].bucketdays = diffDays;
                        }
    ...
    home.dateBucket = function (bucketId, bucketDate) {
        ...
        bucketFactory.compBucket(bucketId, bucketComp)
            ...
            .then(function(returnData){
                ...
                home.dateCalc();
                // if (bucketComp === true) { 
                //     home.bucketStyle = {"text-decoration": "line-through"};
                // } else {
                //     home.bucketStyle = {"text-decoration": "none"};
                // }
                // home.getBucket(); // get many
                // home.Task.taskname = '';
            }).catch(function(err){
